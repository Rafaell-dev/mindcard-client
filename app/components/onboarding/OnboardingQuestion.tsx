    ...
    <div className="flex items-center justify-center gap-4">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <input
          ...
          placeholder="DD"
          className="input-border w-16 h-12 text-center text-lg font-medium rounded-2xl bg-background focus:outline-none transition-colors"
        />
      </div>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <input
          ...
          placeholder="AAAA"
          className="input-border w-20 h-12 text-center text-lg font-medium rounded-2xl bg-background focus:outline-none transition-colors"
        />
      </div>
    </div>
  );
